...
class GPTJForCausalLM(GPTJPreTrainedModel):
    ...
    def __init__(self, config):
        ...
        token_idf = pickle.load(open("token_frequency_data/token_idf_gpt-j-6b.pkl", "rb"))
    ...
    def forward(
        ...
        attention_all = torch.max(torch.max(torch.cat([att.detach().cpu() for att in transformer_outputs.attentions]), dim=0)[0], dim=0)[0]
